...
//I noted this re sanity one: Sanity test: contains newly added critical functionalities -
//the difference between the Smoke one and this one - newly added critical functionalities
//(the newly added ones). It will be done during the sprint - part of our smoke test
* */
...
//        loginPage.username.sendKeys("gino.wintheiser");
        loginPage.username.sendKeys("employee_username");
//        loginPage.password.sendKeys("%B6B*q1!TH");
        loginPage.password.sendKeys("employee_password");
